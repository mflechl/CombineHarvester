...
#S2, no bbb
python ../scripts/projection/compareLimitMSSM.py asymptotic_grid_${tag3}_lumi-35.9_scale-scen2_nobbb.root --scenario-label="m_{h}^{mod+} scenario, S2 (no bbb)" --output="mssm_mhmod_scen2_nobbb" --title-right="35.9 fb^{-1}" --cms-sub="Internal" --contours="exp-2,exp-1,exp0,exp+1,exp+2" --x-range 90,2000 --model_file=/afs/cern.ch/work/m/mflechl/mssm_asymgrid/CMSSW_7_4_7/src/CombineHarvester/MSSMFull2016/shapes/Models/mhmodp_mu200_13TeV.root --extra_contour_file=asymptotic_grid_${tag3}_lumi-300.0_scale-scen2_nobbb.root,asymptotic_grid_${tag3}_lumi-3000.0_scale-scen2_nobbb.root --extra_contour_title='300 fb^{-1}','3000 fb^{-1}' --extra_contour_style=2,2 --extra_contour_color=4,2
